...
public class DBInventoryDAO implements IInventoryDAO
{
    ...
    @Override
    public void insertAccessLog(BytecraftPlayer player, int inventoryId)
    throws DAOException
    {
    ...
    @Override
    public void saveInventory(BytecraftPlayer player, int inventoryID, String type)
    throws DAOException
    {
    ...
    @Override
    public void loadInventory(BytecraftPlayer player, int inventoryID, String type)
    throws DAOException
    {
    ...
    @Override
    public int fetchInventory(BytecraftPlayer player, String inventoryName, String type)
    throws DAOException
    {
