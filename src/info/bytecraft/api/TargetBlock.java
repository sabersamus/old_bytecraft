// Pulled from: https://github.com/toimelin/bukkit
...
public class TargetBlock
{
            ...
            double checkDistance, int[] blocksToIgnore)
    {
        ...
        targetPosDouble =
                new Vector(loc.getX(), loc.getY() + viewHeight, loc.getZ());
        targetPos =
                new Vector(targetPosDouble.getBlockX(),
                        targetPosDouble.getBlockY(),
                        targetPosDouble.getBlockZ());
    ...
    {
        Vector blockUnderPlayer =
                new Vector((int) Math.floor(loc.getX() + 0.5),
    ...
    public boolean setTargetBlock(int typeID)
    {
        if (Material.getMaterial(typeID) != null) {
            ...
            if (getCurrentBlock() != null) {
                Block blk =
                        loc.getWorld().getBlockAt(targetPos.getBlockX(),
    ...
    public boolean setFaceBlock(int typeID)
    {
        if (Material.getMaterial(typeID) != null) {
            if (getCurrentBlock() != null) {
                Block blk =
                        loc.getWorld().getBlockAt(prevPos.getBlockX(),
